                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        if (!empty($this->data['denunciaDetails'][0])) {
                            ...
                            <div class="form-group d-flex">
                                ...
                                <p id="nomeDenuncia" class="mb-0"><?php echo $denuncia['DTITULO']?></p>
                            </div>
                            <div class="form-group d-flex">
                                <label for="descricao" class="mr-2">Descrição:</label>
                                <p id="descricao" class="mb-0"><?php echo $denuncia['DDESCRIACO']?></p>
                            </div>
                            <div class="form-group d-flex">
                                <label for="tipo" class="mr-2">Tipo:</label>
                                <p id="tipo" class="mb-0"><?php echo $denuncia['DTIPO']?></p>
                            </div>
                            <div class="form-group d-flex">
                                <label for="classificacao" class="mr-2">Classificação:</label>
                                <p id="classificacao" class="mb-0"><?php echo $denuncia['DGRAVIDADE']?></p>
                            </div>
                            <div class="form-group d-flex">
                                <label for="classificacao" class="mr-2">Nome do Municipe:</label>
                                <p id="classificacao" class="mb-0"><?php echo $denuncia['DMUNICIPE']?></p>
                            </div>
                            <div class="form-group d-flex">
                                <label for="classificacao" class="mr-2">Status:</label>
                                <p id="classificacao" class="mb-0"><?php echo $denuncia['DSTATUS']?></p>
                            </div>
