        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    $diretorio = URL . 'app/sts/assets/imagens/';

                    // Loop para exibir as imagens
                    foreach (glob($diretorio . "*") as $filename) {
                        // Verifica se o nome do arquivo contém o ID da denúncia
                        if (strpos($filename, $denunciaId) !== false) {
                            echo '<div class="col-lg-3 col-md-4 col-xs-6 thumb">';
                            echo '<a href="' . $filename . '" class="fancybox" rel="ligthbox">';
                            echo '<img src="' . $filename . '" class="zoom img-fluid " alt="">';
                            echo '</a>';
                            echo '</div>';
                        }
                    }
