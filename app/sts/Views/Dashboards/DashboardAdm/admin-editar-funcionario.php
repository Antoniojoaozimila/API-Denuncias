                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nome" id="nome" class="input-adm"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    ?>
                                    <label for="senha">Nr. Telefone</label>
                                    <input type="text" name="telefone" id="telefone" class="input-adm"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nivel_acesso" id="nivel_acesso" class="input-adm"
                                        placeholder="Funcionário" value="funcionario" disabled>
                                </div>
                            </div>
                            ...
                            <button type="submit" name="AtualizarFunc" value="Atualizar">Atualizar</button>
                        </form>
                    </div>
                </div>
