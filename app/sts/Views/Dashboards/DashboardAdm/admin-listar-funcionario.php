            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php
                        if (!empty($this->data['funcionarios']['funcionarioDetails'])) {
                        ?>
                            <table class="table-list">
                                <thead class="list-head">
                                    <tr>
                                        <th class="list-head-content">Nome do Funcionário</th>
                                        <th class="list-head-content">Email</th>
                                        <th class="list-head-content table-sm-none">Foto de Perfil</th>
                                        <th class="list-head-content">Ações</th>
                                    </tr>
                                </thead>
                                <tbody class="list-body">
                                    <?php foreach ($this->data['funcionarios']['funcionarioDetails'] as $funcionario) { ?>
                                        <tr>
                                            <td class="list-body-content"><?php echo $funcionario['nome'] ?></td>
                                            <td class="list-body-content"><?php echo $funcionario['email'] ?></td>
                                            ...
                                            <td class="list-body-content">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="background-color: #ffffff;">
                                                        <a class="dropdown-item" href="<?php echo URL; ?>admin-detalhes-funcionario/index/<?php echo $funcionario['id'] ?>">Visualizar</a>
                                                        <a class="dropdown-item" href="<?php echo URL; ?>admin-editar-funcionario/index/<?php echo $funcionario['id'] ?>">Editar</a>
                                                        <a class="dropdown-item" href="<?php echo URL; ?>admin-remover-funcionario/index/<?php echo $funcionario['id'] ?>">Remover</a>
                                                    </div>
                                                </div>
