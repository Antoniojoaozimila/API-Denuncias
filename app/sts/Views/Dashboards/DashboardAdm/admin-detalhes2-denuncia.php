...
<div id="wrapper">
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        ...
                        ?>
                            ...
                            <div class="form-group d-flex">
                                <label for="classificacao" class="mr-2">Nome do Municipe:</label>
                                <p id="classificacao" class="mb-0">
                                    <?php echo $denuncia['MNOME'] ?>
                                </p>
                            </div>
                            <div class="form-group d-flex">
                                <label for="classificacao" class="mr-2">Nr. de Telefone do Municipe:</label>
                                <p id="classificacao" class="mb-0">
                                    <?php echo $denuncia['TMUNICIPE'] ?>
                                </p>
                            </div>
                            <div class="form-group d-flex">
                            ...
                            <div id="maplet" style="height: 400px; width: 130%; margin-bottom: 20px;">
                                <script>
                                    //inicializacao das coordenadas e zoom do mapa
                        ...
                        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="id_tecnico">
                                        ...
                                        <?php foreach ($this->data['tecnicos'] as $tecnico) { ?>
                            ...
                            <button type="submit" name="AlocarDenuncia" value="Registar" class="btn btn-primary">Alocar</button>
                        </form>
                    </div>
                </div>
                <!-- Content Row -->
    ...
    <script>
        ...
        // Capturar o parametro tecnicoId da URL
        let tecnicoId = getParameterByName('tecnico');

        // Se tecnicoId estiver presente, selecione o técnico no dropdown
        if (tecnicoId) {
            document.querySelector('select[name="id_tecnico"]').value = tecnicoId;
        }
    </script>