    ...
    public function index()
    {
        ...
        if (count($url_parts) >= 4) {
            ...
            if (!empty($id)) {
                ...
                $denunciaModel = new \Sts\Models\AdmsReadUDenuncias();
                ...
                if (!empty($denunciaDetails)) {
                    ...
                    $loadView = new \Core\ConfigView("sts/Views/Dashboards/DashboardUser/usu-detalhes-denuncia", $this->data);
